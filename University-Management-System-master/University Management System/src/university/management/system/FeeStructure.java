...
public class FeeStructure extends JFrame{
    ...
    public FeeStructure(){
        ...
        bb5 = new JLabel("KSH 25000");
        bb5.setBounds(680,170,200,40);
        bb5.setFont(new Font("serif",Font.PLAIN,26));
        add(bb5);
        
        bb6 = new JLabel("KSH 25000");
        bb6.setBounds(680,240,200,40);
        bb6.setFont(new Font("serif",Font.PLAIN,26));
        add(bb6);
        
        bb7 = new JLabel("KSH 25000");
        bb7.setBounds(680,310,200,40);
        bb7.setFont(new Font("serif",Font.PLAIN,26));
        add(bb7);
        
        bb8 = new JLabel("KSH 25000");
        bb8.setBounds(680,380,200,40);
        bb8.setFont(new Font("serif",Font.PLAIN,26));
        add(bb8);
        
        bb13 = new JLabel("KSH 25000");
        bb13.setBounds(680,450,200,40);
        bb13.setFont(new Font("serif",Font.PLAIN,26));
        add(bb13);
        
        bb14 = new JLabel("KSH 25000");
        bb14.setBounds(680,520,200,40);
        ...
        bb9 = new JLabel("KSH 18000");
        bb9.setBounds(880,170,200,40);
        bb9.setFont(new Font("serif",Font.PLAIN,26));
        add(bb9);
        
        bb10 = new JLabel("KSH 18000");
        bb10.setBounds(880,240,200,40);
        bb10.setFont(new Font("serif",Font.PLAIN,26));
        add(bb10);
        
        bb11 = new JLabel("KSH 18000");
        bb11.setBounds(880,310,200,40);
        bb11.setFont(new Font("serif",Font.PLAIN,26));
        add(bb11);
        
        bb12 = new JLabel("KSH 18000");
        bb12.setBounds(880,380,200,40);
        bb12.setFont(new Font("serif",Font.PLAIN,26));
        add(bb12);
        
        bb15 = new JLabel("KSH 18000");
        bb15.setBounds(880,450,200,40);
        bb15.setFont(new Font("serif",Font.PLAIN,26));
        add(bb15);
        
        bb16 = new JLabel("KSH 18000");
        bb16.setBounds(880,520,200,40);
        ...
        m1 = new JLabel("KSH 65000");
        m1.setBounds(1080,170,200,40);
        m1.setFont(new Font("serif",Font.PLAIN,26));
        add(m1);
        
        m2 = new JLabel("KSH 65000");
        m2.setBounds(1080,240,200,40);
        m2.setFont(new Font("serif",Font.PLAIN,26));
        add(m2);
        
        m3 = new JLabel("KSH 65000");
        m3.setBounds(1080,310,200,40);
        m3.setFont(new Font("serif",Font.PLAIN,26));
        add(m3);
        
        m4 = new JLabel("KSH 65000");
        m4.setBounds(1080,380,200,40);
        ...
        m5 = new JLabel("KSH 55000");
        m5.setBounds(1280,170,200,40);
        m5.setFont(new Font("serif",Font.PLAIN,26));
        add(m5);
        
        m6 = new JLabel("KSH 55000");
        m6.setBounds(1280,240,200,40);
        m6.setFont(new Font("serif",Font.PLAIN,26));
        add(m6);
        
        m7 = new JLabel("KSH 55000");
        m7.setBounds(1280,310,200,40);
        m7.setFont(new Font("serif",Font.PLAIN,26));
        add(m7);
        
        m8 = new JLabel("KSH 55000");
        m8.setBounds(1280,380,200,40);
        ...
        m9 = new JLabel("KSH 81000");
        m9.setBounds(1480,170,200,40);
        m9.setFont(new Font("serif",Font.PLAIN,26));
        add(m9);
        
        m10 = new JLabel("KSH 81000");
        m10.setBounds(1480,240,200,40);
        m10.setFont(new Font("serif",Font.PLAIN,26));
        add(m10);
        
        m11 = new JLabel("KSH 81000");
        m11.setBounds(1480,310,200,40);
        m11.setFont(new Font("serif",Font.PLAIN,26));
        add(m11);
        
        m12 = new JLabel("KSH 81000");
        m12.setBounds(1480,380,200,40);
