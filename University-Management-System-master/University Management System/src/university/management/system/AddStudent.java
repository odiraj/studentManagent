...
//        id15.add(t9);
        ...
        id12= new JLabel("Registration No");
	...
	lab.setFont(new Font("serif",Font.BOLD,20));
        ...
        String course[] = {"Computer Science","Public Health","Electrical Engineering","Education","Law","Industrial Chemistry","Procurement"};
        c1 = new JComboBox(course);
        c1.setBackground(Color.WHITE);
        c1.setBounds(600,400,150,30);
        id15.add(c1);
        
        lab2=new JLabel("Faculty");
        lab2.setBounds(50,450,150,30);
	lab2.setFont(new Font("serif",Font.BOLD,20));
        id15.add(lab2);
        
        String faculty[] = {"FSET","FBUST","FERD","FPHN","FHSS"};
        c2 = new JComboBox(faculty);
       ...
       // String i = t9.getText();
        ...
        if(ae.getSource() == b){
            ...
            conn = DriverManager.getConnection(url, user, pass);
                String q = "insert into student values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+j+"','"+k+"','"+l+"','"+m+"')";
